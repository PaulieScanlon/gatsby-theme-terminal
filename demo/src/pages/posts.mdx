    ...
    >
      {posts.map((edge, index) => {
        ...
        return (
          ...
          >
             <Link href={slug} sx={{ textDecoration: "none", display: 'flex', flex: '1 1 auto', flexDirection: 'column', m: theme => `0px ${theme.space[2]}px` }}>
    
               <Card sx={{ display: 'flex', flex: '1 1 auto', flexDirection: 'column' }}>
