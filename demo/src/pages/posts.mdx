    ...
    >
      {posts.map((edge, index) => {
        ...
        return (
          <Box
            key={index}
            sx={{ display: 'flex', mb: 3, width: ["100%", "100%", "50%", "33.333%"], pl: 2, pr: 2, outline: '1px solid red' }}
          >
            {/* <Link href={slug} sx={{ textDecoration: "none", display: 'flex', flex: '1 1 auto' }}>
             <Box sx={{border: '1px solid red', display: 'flex', flex: '1 1 auto'}}> */}
               <Card sx={{ display: 'flex', flexDirection: 'column', flex: '1 1 auto', outline: '1px solid blue' }}>
                ...
                > */}
                  ...
                  <Box sx={{flex: '1 1 auto',  border: '1px solid yellow',}}>
